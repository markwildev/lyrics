              ...
              <section class="mt-4">     
                  <div class="row row-sm">
                    <div class="form-group col-md-6">
                      <label class="text-uppercase font-light">First Name</label>                  
                      <input type="text" class="form-control" name="first_name">
                    </div>
                    <div class="form-group col-md-6">
                      <label class="text-uppercase font-light">Middle Name</label>                  
                      <input type="text" class="form-control" name="middle_name">
                    </div>
                    <div class="form-group col-md-6">
                      <label class="text-uppercase font-light">Last Name</label>                  
