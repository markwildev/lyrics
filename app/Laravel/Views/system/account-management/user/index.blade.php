...
<div class="content content-components section-wrapper mb-5">
      <div>
        <div class="d-flex justify-content-md-between mb-2">
          <h4 id="section1" class="mb-3 mb-lg-0 mb-md-0 mb-xl-0">List of User</h4>
	              ...
	              <table class="table table-hover mg-b-0">
	                ...
	                <tbody>
	                  <tr>
	                    ...
	                    <td>
	                     <a href="{{route('system.account_management.user.list_of_transaction')}}" title="View Transaction" class="btn btn-sm btn-light text-white bg-success">
